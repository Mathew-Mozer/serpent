...
<div class="promotion-view" id=<?php echo "\"promotion-list-" . $property['id'] . "\""; ?>>
    <h2 class="property-title"><?php echo $property['propertyName'];?></h2>
    <!--New Promotion Title-->
    <?php
    if($permission->hasPermission('property',$property['id'],'C')){?>
    <div id=<?php echo "\"" . $property['id'] . "\""; ?> class="add-promotion-btn tile-body tile-insert">
    ...
    $promotionList = $promotion->getAllPromotionsByProperty($property['id']);
