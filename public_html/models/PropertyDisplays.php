      ...
      foreach($promotions as $promotion){
        ...
        $sql= "SELECT * FROM promotion_property WHERE promotion_id=:promotion_id AND property_id=:property_id;";
          ...
          if($result->rowCount() > 0){
            $sql= "UPDATE promotion_property SET display_id=:display_id WHERE promotion_id=:promotion_id, scene_duration=:scene_duration AND property_id=:property_id;";
            ...
            $sql= "INSERT INTO promotion_property (promotion_id, property_id, display_id, scene_duration)VALUES (:promotion_id, :propertyId, :display_id, :scene_duration);";
